...
// Set explicitly for the upcoming seasons
const SEASONS = [2026];
...
function FixturesPage() {
    ...
    async function fetchData() {
        try {
            ...
            // FILTER: Remove finished matches for the Fixtures page (keep upcoming, live, etc.)
            const upcomingMatches = normalised.filter(
    ...
    return (
        <div className="page">
            ...
            <div className="detail-header">
                ...
                <h1>{selectedLeague.name} Fixtures</h1>
            </div>
            ...
            {loading ? (
                ...
                <p className="state">No upcoming fixtures found.</p>
            ) : (
                rounds.map(round => (
                            ...
                            {grouped[round].map(fixture => {
                                ...
                                return (
                                    <div
                                        ...
                                        onClick={() => navigate(`/fixtures/${fixture.fixture_id}`, {
